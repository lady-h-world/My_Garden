...
We have now explored forecasting with the Silverkite template. As shown in [Table 3.2][4], the Prophet template delivers even better performance. How does applying the Prophet template differ? Let’s move forward and find out!
