...
To apply VECM in multivariate time series outlier detection, the code is quite similar to VAR outlier detection, we just need to reaplce VAR with VECM 😉
...
After applying VAR and VECM in outlier detection, are you curious how different the detection output will be? Lady H. was also quite curious about it and did a comparison. In this problem, among all the 8143 records, only 2 of them had different outlier detection results.
