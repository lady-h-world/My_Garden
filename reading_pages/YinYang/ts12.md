...
We can also explore the weekly seasonality by looking at day of week patterns in each month. It seems that every month is showing similar patterns that Monday tends to have a bit higher sales while Sunday has 0 sales because all the stores are closed.
...
Similarly, we can plot monthly day of week patterns in this way, which can disclose weekly seasonality in all years. The sales patterns on Monday and Sunday are still quite different from other day of week.
...
But are you going to wonder whether every week in a month, we will see the same pretty patterns above? Let's look at day of week patterns by day of month. Ah! It seems that Monday doesn't lead sales every week, especailly around 10th or 20th in a month, Monday sales can be lower than other day of week.
...
You can also randomly choose multiple periods and plot their sales patterns. For example, here Lady H. chose 20 weeks sales patterns randomly, most of the weeks are showing similar patterns but the week of 2015-05-31 is a special one, its Friday sales was much lower than average while its other weekdays' sales were much higher than the average. From there, we can dive deeper to undersatnd more.
