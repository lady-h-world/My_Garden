...
The way Kats ACF detector gets seasonality length is to look into ACF output confidence interval list, and find repeated cycle that has confidence interval larger than 1. You can dive deeper [here][8].
