...
Now we have went through forecasting with Silverkite. As we saw in [Table 3.2][4], Prophet template has improved MAPE even further. How different it is when applying Prophet template? Let's move forward to learn more!
